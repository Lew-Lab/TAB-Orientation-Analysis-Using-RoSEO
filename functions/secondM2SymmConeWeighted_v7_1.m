% 190730 - v7_1 TD - Ground truth initial
...
function [mux,muy,muz,rotMobil,x0]= secondM2SymmConeWeighted_v7_1(bx,by,Bx,By,sumNorm,secM,signal,backg,locPosROIRefMu)
